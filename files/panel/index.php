...
<?php /* Dont Edit Anything After This Line*/
...
<link rel="shortcut icon" type="image/x-icon" href="https://github.com/korn-sudo/Project-Fog/raw/main/files/panel/ACIII.png">
...
<a class="navbar-brand" href="/">
  <img src="https://github.com/korn-sudo/Project-Fog/raw/main/files/panel/ACIII.png" width="30" height="30" class="d-inline-block align-top" alt="">
  <?php echo $site_name; ?>
</a>
...
<li class="nav-item active">
<a class="nav-link" href="<?php echo https://m.facebook.com/kornips; ?>"target="_blank">Project Fog Contacts: <span class="sr-only">(current)</span></a>
</li>
<li class="nav-item active">
<a class="nav-link" href="<?php echo https://github.com/korn-sudo/Project-Fog; ?>"target="_blank">This is Not For Sale!: <span class="sr-only">(current)</span></a>
</li>
</nav>		
</header>
	<div align="center">
